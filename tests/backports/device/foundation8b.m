...
#import "foundation8b-expectations.h"
...
{
    @autoreleasepool {
        NSDictionary *expected = [NSJSONSerialization JSONObjectWithData:[NSData dataWithBytes:foundation8b_expectations length:strlen(foundation8b_expectations)] options:0 error:NULL];
        NSMutableDictionary *records = [NSMutableDictionary dictionary];
        foundation8b_run(^(NSString *name, NSString *value) {
            records[name] = value;
