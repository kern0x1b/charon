...
#import "progress-expectations.h"
...
{
    @autoreleasepool {
        NSDictionary *expected = [NSJSONSerialization JSONObjectWithData:[NSData dataWithBytes:progress_expectations length:strlen(progress_expectations)] options:0 error:NULL];
        NSMutableDictionary *records = [NSMutableDictionary dictionary];
        progress_run(^(NSString *name, NSString *value) {
            records[name] = value;
