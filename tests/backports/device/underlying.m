...
#import "underlying-expectations.h"
...
{
    @autoreleasepool {
        NSDictionary *expected = [NSJSONSerialization JSONObjectWithData:[NSData dataWithBytes:underlying_expectations length:strlen(underlying_expectations)] options:0 error:NULL];
        NSMutableDictionary *records = [NSMutableDictionary dictionary];
        underlying_run(^NSOperationQueue *{ return [[NSOperationQueue alloc] init]; }, ^(NSString *name, NSString *value) {
            records[name] = value;
