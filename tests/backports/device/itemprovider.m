...
#import "itemprovider-expectations.h"
...
{
    @autoreleasepool {
        NSDictionary *expected = [NSJSONSerialization JSONObjectWithData:[NSData dataWithBytes:itemprovider_expectations length:strlen(itemprovider_expectations)] options:0 error:NULL];
        NSMutableDictionary *records = [NSMutableDictionary dictionary];
        itemprovider_run(^(NSString *name, NSString *value) {
            records[name] = value;
