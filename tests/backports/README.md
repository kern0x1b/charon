...
The first expects the page sheet from every way a controller is made without a style, the second full screen; both keep a style that is set or archived.
