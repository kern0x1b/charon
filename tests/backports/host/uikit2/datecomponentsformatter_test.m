...
int main(int argc, char **argv)
{
    @autoreleasepool {
        ...
        charon_check(wrong == 0, "the formatter answers as the system's for random configurations", [NSString stringWithFormat:@"%lu of %lu differ", (unsigned long)wrong, (unsigned long)total]);
    }
