...
windowed compositionallayout "NSCollectionLayoutValues.m NSCollectionLayoutItems.m UICollectionViewCompositionalLayout.m CharonOrthogonalScroll.m CharonSelfSizing.m NSCollectionLayoutSection+iOS14.m UICollectionViewCompositionalLayoutConfiguration+iOS14.m UICollectionViewCompositionalLayout+ListConfiguration.m CharonLists.m" "*" compositionallayout_test.m
windowed orthogonal "NSCollectionLayoutValues.m NSCollectionLayoutItems.m UICollectionViewCompositionalLayout.m CharonOrthogonalScroll.m CharonSelfSizing.m NSCollectionLayoutSection+iOS14.m UICollectionViewCompositionalLayoutConfiguration+iOS14.m UICollectionViewCompositionalLayout+ListConfiguration.m CharonLists.m" "*" orthogonal_test.m
windowed sizedlayout "NSCollectionLayoutValues.m NSCollectionLayoutItems.m UICollectionViewCompositionalLayout.m CharonOrthogonalScroll.m CharonSelfSizing.m NSCollectionLayoutSection+iOS14.m UICollectionViewCompositionalLayoutConfiguration+iOS14.m UICollectionViewCompositionalLayout+ListConfiguration.m CharonLists.m" "*" sizedlayout_test.m
...
windowed_renamed listcell "CharonLists.m CharonConfigurationHost.m UICellAccessory.m UIViewConfigurationState.m UIListContentProperties.m UIListContentConfiguration.m UIBackgroundConfiguration.m UIListContentView.m UICollectionViewCell+Configuration.m UITableViewCell+Configuration.m UITableViewHeaderFooterView+Configuration.m UICollectionViewListCell.m UICollectionView+Editing.m UICollectionViewRegistration.m UICollectionLayoutListConfiguration.m UICollectionViewCompositionalLayout+ListConfiguration.m NSCollectionLayoutValues.m NSCollectionLayoutItems.m UICollectionViewCompositionalLayout.m CharonOrthogonalScroll.m CharonSelfSizing.m NSCollectionLayoutSection+iOS14.m UICollectionViewCompositionalLayoutConfiguration+iOS14.m NSDiffableDataSourceSnapshot.m CharonDiffable.m UICollectionViewDiffableDataSource.m CharonSwipeViews.m UICollectionView+SwipeActions.m UIContextualAction.m UISwipeActionsConfiguration.m" "contentConfiguration setContentConfiguration automaticallyUpdatesContentConfiguration setAutomaticallyUpdatesContentConfiguration backgroundConfiguration setBackgroundConfiguration automaticallyUpdatesBackgroundConfiguration setAutomaticallyUpdatesBackgroundConfiguration configurationState setNeedsUpdateConfiguration updateConfigurationUsingState defaultContentConfiguration isEditing setEditing allowsSelectionDuringEditing setAllowsSelectionDuringEditing allowsMultipleSelectionDuringEditing setAllowsMultipleSelectionDuringEditing dequeueConfiguredReusableCellWithRegistration dequeueConfiguredReusableSupplementaryViewWithRegistration" listcell_test.m
