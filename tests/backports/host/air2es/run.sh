...
for library, names in (('quad', ('quad-vertex', 'quad-fragment', 'quad-stagein')), ('pair', ('pair',))):
...
for file in library.json module0.vert module0.json module1.frag module1.json module2.vert module2.json; do
