package("apple-backports")
    ...
    on_install("iphoneos", function (package)
        ...
        local libraries = table.join({"FoundationBackports"}, (package:config("uikit") or package:config("avkit")) and {"UIKitBackports"} or {},
