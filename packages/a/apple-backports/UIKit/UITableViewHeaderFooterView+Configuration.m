...
@implementation UITableViewHeaderFooterView (CharonConfiguration)
...
{
    return (UIViewConfigurationState *)[self charon_makeConfigurationState];
}
...
{
    return [[UIListContentConfiguration alloc] initCharonWithStyle:CharonListStyleHeader];
}
