# Names of CoreTelephony that iOS 7 to 12 added

A notification name of the framework.

Source: CoreTelephony of the arm64 shared cache of iOS 12.0, where each constant is a string and its text was read; the header of iOS 16.4 for the type and the release that added each name;
