# UITableViewCell and UITableViewHeaderFooterView configuration, iOS 14.0

The same properties as the collection view cell, with `defaultContentConfiguration` chosen by the style the cell was made with (default, subtitle, value1, value2) and, for a header, the header style.
