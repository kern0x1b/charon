# Names of CoreGraphics that iOS 7 to 12 added

Constant strings of the framework.

Source: CoreGraphics of the arm64 shared cache of iOS 12.0, where each constant is a string and its text was read; the header of iOS 16.4 for the type and the release that added each name;
