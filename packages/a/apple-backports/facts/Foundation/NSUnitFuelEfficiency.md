...
base unit, which is `+litersPer100Kilometers`.
...
|---|---|---|---|---|---|
| `litersPer100Kilometers` | `L/100km` | linear | 1 | 0 | 3330 |
| `milesPerImperialGallon` | `mpg` | reciprocal | 282.481 | 0 | 3331 |
| `milesPerGallon` | `mpg` | reciprocal | 235.215 | 0 | 3329 |
