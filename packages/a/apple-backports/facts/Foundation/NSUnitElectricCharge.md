...
|---|---|---|---|---|---|
| `coulombs` | `C` | linear | 1 | 0 | — |
| `megaampereHours` | `MAh` | linear | 3600000000 | 0 | — |
| `kiloampereHours` | `kAh` | linear | 3600000 | 0 | — |
| `ampereHours` | `Ah` | linear | 3600 | 0 | — |
| `milliampereHours` | `mAh` | linear | 3.6 | 0 | — |
| `microampereHours` | `µAh` | linear | 0.0036 | 0 | — |
