...
|---|---|---|---|---|---|
| `megaamperes` | `MA` | linear | 1000000 | 0 | — |
| `kiloamperes` | `kA` | linear | 1000 | 0 | — |
| `amperes` | `A` | linear | 1 | 0 | 3840 |
| `milliamperes` | `mA` | linear | 0.001 | 0 | 3841 |
| `microamperes` | `µA` | linear | 1e-06 | 0 | — |
