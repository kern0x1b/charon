# Names of Security that iOS 7 to 12 added

Constant strings of the framework: the attributes and the values of an item of the keychain, the classes of keys, and the algorithms and parameters of the key operations of iOS 10 and 11.

Source: Security of the arm64 shared cache of iOS 12.0, where each constant is a string and its text was read; the header of iOS 16.4 for the type and the release that added each name;
