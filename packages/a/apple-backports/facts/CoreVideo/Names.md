# Names of CoreVideo that iOS 7 to 12 added

Constant strings of the framework: the keys and values of a pixel buffer attachment (the colour primaries, the transfer functions and the matrices) and of the options of a pixel buffer and its caches.

Source: CoreVideo of the arm64 shared cache of iOS 12.0, where each constant is a string and its text was read; the header of iOS 16.4 for the type and the release that added each name;
