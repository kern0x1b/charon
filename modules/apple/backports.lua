...
LIBRARIES = {
    ...
    {name = "AVFoundationBackports", folder = "AVFoundation", frameworks = {"AVFoundation", "CoreMedia", "CoreVideo", "AudioToolbox", "CoreImage", "ImageIO", "CoreGraphics", "UIKit", "Foundation"}, libraries = {"FoundationBackports"}},
