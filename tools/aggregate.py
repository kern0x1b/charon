...
# caches/ (the framework-attribution *.tsv ladder, 6.0/7.0.1/10.3.4/12.0/18.0) is carried from the
# prior wave's scratchpad, not regenerated by anything in this repo -- CHARON_CACHES_DIR lets it
# move without a hardcoded path rotting again, same pattern as CHARON_TREE_DIR in crash-demand.py.
CACHES = os.environ.get("CHARON_CACHES_DIR") or os.path.join(HERE, "..", "caches")
