...
def main():
    ...
    _CACHES_SEL_CANDIDATES = [p for p in [
        ...
        os.path.join(os.path.expanduser("~"), "Git", "projects", "ios", "coordination", "corpus", "caches"),
        os.path.join(BASE, "caches"),
    ] if p]
    ...
    with open(os.path.join(BASE, "corpus", "crash-demand-dropped.tsv"), "w") as f:
